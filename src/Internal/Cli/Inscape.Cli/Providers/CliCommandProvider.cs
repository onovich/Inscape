    ...
    internal static class CliCommandProvider {
        ...
        static readonly CliCommandModel[] CommandModels = new[] {
            ...
            new CliCommandModel("runtime-project", "Project", true,
                                     ...
                                     "inscape runtime-project <root> [--entry node.name] [--state runtime-state.json] [--continue|--rewind|--choose group option] [-o runtime-state.json]",
        ...
        public static void PrintUsage() {
            ...
            Console.WriteLine("  inscape runtime-project <root> [--entry node.name] [--state runtime-state.json] [--continue|--rewind|--choose group option] [-o runtime-state.json]");
