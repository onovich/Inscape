...
const preloadMethodsByCommand = Object.freeze({
  ...
  [EditorBackendTransportCommand.RuntimeSubstateExport]: ["runtimeSession", "substateExport"],
  [EditorBackendTransportCommand.RuntimeSubstateImport]: ["runtimeSession", "substateImport"],
  ...
  [EditorBackendTransportCommand.RuntimeSubstateValidate]: ["runtimeSession", "substateValidate"],
  ...
  [EditorBackendTransportCommand.StableNodeMapWriteSidecar]: ["stableNodeMap", "writeSidecar"],
