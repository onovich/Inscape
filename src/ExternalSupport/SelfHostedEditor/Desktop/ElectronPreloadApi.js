...
export const SelfHostedEditorPreloadEditorCommand = Object.freeze({
  ...
  RuntimeSubstateExport: "runtime.export-substate",
  RuntimeSubstateImport: "runtime.import-substate",
  RuntimeStartOrObserve: "runtime.start-or-observe",
  RuntimeStep: "runtime.step",
  RuntimeSubstateValidate: "runtime.validate-substate",
...
const preloadPayloadKeysByCommand = Object.freeze({
  ...
  [SelfHostedEditorPreloadEditorCommand.RuntimeSubstateExport]: ["actionDispatcher", "hostCheckpointId", "queryProvider", "runtimeState", "scriptText", "scriptVersion", "sessionId", "workspace"],
  [SelfHostedEditorPreloadEditorCommand.RuntimeSubstateImport]: ["actionDispatcher", "queryProvider", "scriptText", "scriptVersion", "sessionId", "substate", "substateText", "workspace"],
  [SelfHostedEditorPreloadEditorCommand.RuntimeStartOrObserve]: ["actionDispatcher", "queryProvider", "scriptText", "sessionId", "workspace"],
  [SelfHostedEditorPreloadEditorCommand.RuntimeStep]: ["action", "actionDispatcher", "queryProvider", "runtimeState", "scriptText", "sessionId", "workspace"],
  [SelfHostedEditorPreloadEditorCommand.RuntimeSubstateValidate]: ["scriptText", "scriptVersion", "sessionId", "substate", "substateText", "workspace"],
...
export function createSelfHostedEditorPreloadApi(options = {}) {
  ...
  return Object.freeze({
    ...
    runtimeSession: Object.freeze({
      substateExport: createEditorCommandHandler(SelfHostedEditorPreloadEditorCommand.RuntimeSubstateExport, handlers),
      substateImport: createEditorCommandHandler(SelfHostedEditorPreloadEditorCommand.RuntimeSubstateImport, handlers),
      ...
      substateValidate: createEditorCommandHandler(SelfHostedEditorPreloadEditorCommand.RuntimeSubstateValidate, handlers),
    }),
