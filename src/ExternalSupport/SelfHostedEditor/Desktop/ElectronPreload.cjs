...
const preloadPayloadKeysByCommand = Object.freeze({
  ...
  [SelfHostedEditorPreloadEditorCommand.RuntimeStartOrObserve]: ["queryProvider", "scriptText", "sessionId", "workspace"],
  [SelfHostedEditorPreloadEditorCommand.RuntimeStep]: ["action", "queryProvider", "runtimeState", "scriptText", "sessionId", "workspace"],
