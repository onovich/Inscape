const selfHostedEditorApiRouteDefinitions = [
  ...
  ["runtimeSubstateExport", "/api/runtime-substate-export"],
  ["runtimeSubstateImport", "/api/runtime-substate-import"],
  ["runtimeSubstateValidate", "/api/runtime-substate-validate"],
