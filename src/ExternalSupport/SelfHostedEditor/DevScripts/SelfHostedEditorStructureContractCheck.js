...
const requiredPaths = [
  ...
  "DevScripts/SelfHostedEditorDesktopGuiRecoverySmoke.js",
  "DevScripts/SelfHostedEditorDesktopPackageContractCheck.js",
  "DevScripts/SelfHostedEditorDesktopPackageGuiSmoke.js",
  ...
  "DevScripts/ModelContracts/SelfHostedEditorRuntimeErrorStateInventoryContractCheck.js",
  ...
  "Scripts/Backend/Models/EditorBackendSettingsSchemaModel.js",
  "Scripts/Backend/Models/EditorBackendWorkspaceAssetImportPlanModel.js",
  "Scripts/Backend/Models/EditorBackendWorkspaceBackupPlanModel.js",
  "Scripts/Backend/Models/EditorBackendWorkspaceRequestModel.js",
  ...
  "Scripts/Backend/Models/EditorBackendWorkspaceSessionCleanupModel.js",
  "Scripts/Backend/Models/EditorBackendWorkspaceSnapshotModel.js",
  ...
  "Scripts/Runtime/Models/RuntimeErrorStateInventoryModelBuilder.js",
...
if (
  !/^\.runtime-action-panel\s*{/m.test(workbenchRuntimeActionAuthoringCss)
  || !/^\.runtime-action-header,\r?\n\.runtime-action-toolbar,\r?\n\.runtime-action-row-summary\s*{/m.test(workbenchRuntimeActionAuthoringCss)
  || !/^\.runtime-action-row\s*{/m.test(workbenchRuntimeActionAuthoringCss)
  || !/^\.runtime-action-requests,\r?\n\.runtime-action-pending\s*{/m.test(workbenchRuntimeActionAuthoringCss)
  || !/^\.runtime-action-button\s*{/m.test(workbenchRuntimeActionAuthoringCss)
) {
  console.error("SelfHostedEditorRuntimeActionAuthoring.css must retain action panel, header, row, evidence, pending, and resume button rules.");
  failed = true;
}
...
if (
  !/^\.runtime-log-backlog-panel\s*{/m.test(workbenchRuntimeLogBacklogCss)
  || !/^\.runtime-log-backlog-header,\r?\n\.runtime-log-backlog-entry-summary\s*{/m.test(workbenchRuntimeLogBacklogCss)
  || !/^\.runtime-log-backlog-entry\s*{/m.test(workbenchRuntimeLogBacklogCss)
  || !/^\.runtime-log-backlog-source-button\s*{/m.test(workbenchRuntimeLogBacklogCss)
) {
  console.error("SelfHostedEditorRuntimeLogBacklog.css must retain log panel, header, entry, and source button rules.");
  failed = true;
}
...
if (packageJson.scripts["smoke:desktop-gui-recovery"] !== "node DevScripts/SelfHostedEditorDesktopGuiRecoverySmoke.js") {
  console.error("SelfHostedEditor smoke:desktop-gui-recovery must delegate to SelfHostedEditorDesktopGuiRecoverySmoke.js.");
  failed = true;
}
...
if (packageJson.scripts["smoke:desktop-package-gui"] !== "node DevScripts/SelfHostedEditorDesktopPackageGuiSmoke.js") {
  console.error("SelfHostedEditor smoke:desktop-package-gui must delegate to SelfHostedEditorDesktopPackageGuiSmoke.js.");
  failed = true;
}
if (packageJson.scripts["smoke:desktop-runtime"] !== "node DevScripts/SelfHostedEditorDesktopRuntimeSmoke.js") {
  console.error("SelfHostedEditor smoke:desktop-runtime must delegate to SelfHostedEditorDesktopRuntimeSmoke.js.");
  failed = true;
}
if (packageJson.scripts["smoke:desktop-startup"] !== "node DevScripts/SelfHostedEditorDesktopStartupSmoke.js") {
  console.error("SelfHostedEditor smoke:desktop-startup must delegate to SelfHostedEditorDesktopStartupSmoke.js.");
  failed = true;
}
if (packageJson.scripts["check:desktop-package"] !== "node DevScripts/SelfHostedEditorDesktopPackageContractCheck.js") {
  console.error("SelfHostedEditor check:desktop-package must delegate to SelfHostedEditorDesktopPackageContractCheck.js.");
  failed = true;
}
if (packageJson.scripts["package:windows"] !== "electron-builder --win dir --x64") {
  console.error("SelfHostedEditor package:windows must build a Windows x64 unpacked directory with electron-builder.");
  failed = true;
}
if (packageJson.scripts["start:desktop"] !== "electron Desktop/ElectronMain.js") {
  console.error("SelfHostedEditor start:desktop must launch Desktop/ElectronMain.js with Electron.");
  failed = true;
}
...
if (packageJson.scripts["check:electron-workspace"] !== "node DevScripts/SelfHostedEditorElectronWorkspaceContractCheck.js") {
  console.error("SelfHostedEditor check:electron-workspace must delegate to SelfHostedEditorElectronWorkspaceContractCheck.js.");
  failed = true;
}
