...
- [ ] 下一步：P5 final validation / PASS-FAIL 收口，输出 `docs/self-hosted-editor-p5-final-validation-report.md`。若 final validation 暴露阻塞缺陷，再进入 P5 Round 13-15 缓冲修复；继续禁止完整 host save、Unity / Bird / Host SDK、Rollback / Trace Replay / Flashback 与 Host Schema action policy 扩张。
