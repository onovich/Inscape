...
- [ ] 下一轮：P5 Round 8 Log / Backlog surface。按 [P5 SelfHostedEditor Runtime Authoring Goal 模式执行指南](self-hosted-editor-p5-goal-mode-execution-guide.md) 只展示 Runtime `logEntries`，支持空状态和 Runtime unavailable，不写入 formal Runtime State。
