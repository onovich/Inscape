...
- [ ] 下一候选方向必须由用户批准。不要自动进入完整 host save、Unity / Bird / Host SDK、Rollback / Trace Replay / Flashback、Presentation IR 或 Host Schema action policy 扩张；若要继续其中任一方向，先产出新的 goal-mode execution guide。
