...
- [ ] 执行 Host Bridge Candidate Generator First Slice 阶段，按 6 轮 guide 完成 standalone package candidate generator、shared Tooling domain、CLI command、smoke、docs closure 和 final validation；每轮必须 Debug 自检、架构自检、验证通过后提交推送，再进入下一轮。
