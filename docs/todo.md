...
- [ ] 继续 Host Integration Package CLI Round 5 Smoke Fixtures / Determinism / Docs：补 package CLI smoke 或 Internal test、重复导出 determinism、边界扫描和 docs 口径；仍禁止 partner-specific import 判断、Host Bridge candidate generator / generated apply / runtime / host save / policy 扩张。
