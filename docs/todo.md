...
- [ ] 实现 autosave / flush / recovery：手动 Save、autosave timer、close/switch/app-exit flush、recovery restore / discard / later 已可通过 Electron main process 真实 IO 工作；仍需补 GUI recovery smoke。
