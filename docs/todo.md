...
- [ ] 等待用户批准下一候选方向。不要自动进入完整 host save、Unity / Bird / Host SDK、Rollback / Trace Replay / Flashback、Presentation IR 或 Host Schema action policy 扩张；若要继续其中任一方向，先由用户批准，再产出该方向新的 goal-mode execution guide。
