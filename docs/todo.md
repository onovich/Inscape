...
- [ ] 输出 Host Integration Partner Readiness 的独立 goal-mode execution guide。该阶段只做 contract / fixture / report / planning；不得自动进入完整 host save、Unity / Bird / Host SDK、Rollback / Trace Replay / Flashback、Presentation IR、Runtime Preview Bridge、Sinan Runtime Integration 或 Host Schema action policy 扩张。
