...
- [ ] 执行 Static Artifact POC Partner Handoff Kit 阶段，按 4 轮 guide 完成 partner handoff kit、feedback schema / fixture、handoff smoke、docs closure 和 final validation；每轮必须 Debug 自检、架构自检、验证通过后提交推送，再进入下一轮。
