...
- [ ] 下一轮：P5 Round 12 integration smoke + docs closure。串起 Runtime-backed Preview、Mock Query、Action pending / resume、Log、Branch Receipts、Substate 与 Runtime States 总览的端到端 smoke；继续禁止完整 host save、Unity / Bird / Host SDK、Rollback / Trace Replay / Flashback 与 Host Schema action policy 扩张。
