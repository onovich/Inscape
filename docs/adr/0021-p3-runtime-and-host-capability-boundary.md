...
- 条件语法 contract / parser design 已在 P3 Round 7 收口到 [Condition Syntax Contract](../condition-syntax-contract.md)；Compiler parser / IR 最小实现已在 P3 Round 8 完成，Tooling / LanguageServer / Editor consumption 已在 P3 Round 9 完成。后续仍需实现 Runtime query provider、query receipt、Runtime State 与条件求值。
