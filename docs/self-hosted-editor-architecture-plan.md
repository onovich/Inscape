...
- 2026-06-17 当前状态：P1 Round 36 已补等价本机启动 smoke。`smoke:desktop-startup` 验证 package / Desktop entry / Workbench / preload / contract loop，并明确记录当前尚未安装 Electron runtime、尚未生成 Windows package；真实 GUI/package smoke 后续补。
