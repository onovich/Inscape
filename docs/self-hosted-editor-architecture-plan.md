...
- 2026-06-17 当前状态：P1 Round 33 已补 assets import policy contract。外部图片、音频、CSV 导入会生成复制到 workspace `assets/images|audio|data` 的 text-free plan，不持久化 workspace 外路径；`assets/**` 写目标优先于扩展名规则，真实文件复制仍待 IO 层。
