...
- 2026-06-17 当前状态：P1 Round 32 已补 write-back backup plan contract。localization CSV、node-map sidecar、line-map sidecar 写回前会生成 `.inscape-workspace/backups/` 下的 text-free backup request，并附带 count-and-age retention cleanup candidates；真实文件复制 / 删除仍待 IO 层。
