...
P2 Round 14 的全量验证还必须覆盖 VSCode semantic parity、SelfHostedEditor localization review/update、line-map、node-map、workbench integration 与 semantic parity HTTP smoke。Round 14 通过前不得开启 P2.5 Host Schema / Host Bridge / Unity-Bird 工作；失败时先进入第 15-18 轮缓冲修复。
