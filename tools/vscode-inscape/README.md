...
- Refreshes diagnostics by invoking `dotnet run --project src/Inscape.Cli/Inscape.Cli.csproj -- diagnose <temp-file>`.
- Provides current-file node completions in jump target positions.
